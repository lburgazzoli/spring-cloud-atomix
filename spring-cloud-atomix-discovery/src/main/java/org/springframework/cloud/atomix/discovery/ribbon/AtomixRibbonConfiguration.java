...
/**
 * Preprocessor that configures defaults for atomix-discovered ribbon clients. Such as:
...
public class AtomixRibbonConfiguration {
	...
	protected void setProp(String serviceId, String suffix, String value) {
		...
		final String key = getKey(serviceId, suffix);
		final DynamicStringProperty property = getProperty(key);
